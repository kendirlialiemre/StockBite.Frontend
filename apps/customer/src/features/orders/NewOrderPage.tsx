      ...
      {!selectedTable ? (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <button
              onClick={() => setSelectedTable({ id: '', name: 'Paket', orderId: null, total: 0, itemCount: 0, openedAt: new Date().toISOString(), isTimerPaused: false, timerOffsetSeconds: 0, timerLastStartedAt: new Date().toISOString(), isPackage: true })}
